...
(function (c, ea, $, L) {
            ...
            return this.each(function () {
                ...
                if (!e.data("isActive")) {
                    ...
                    var ba = function () {
                        ...
                        } else"double" === a.type && (q.append('<span class="irs-diapason"></span><span class="irs-slider from"></span><span class="irs-slider to"></span>'),
                        ...
                        "single" === a.type ? (b.fromX = c.data(w[0], "x") || parseInt(w[0].style.left, 10) || w.position().left, b.fromPers = b.fromX / E * 100, h = d / 100 * b.fromPers + a.min, b.fromNumber = Math.round(h / a.step) * a.step, b.fromNumber < a.min && (b.fromNumber = a.min), b.fromNumber > a.max && (b.fromNumber = a.max), u && (b.fromNumber = parseInt(b.fromNumber * u, 10) / u), H && (b.fromValue = a.values[b.fromNumber])) :
                        ...
                        for (b = 0; 4 >= b; b += 1)c = Math.floor(l / 4 * b), c >= l && (c = l - 1), e += '<span class="irs-grid-pol" style="left: ' + c + 'px;"></span>', u ? (d = a.min + (a.max - a.min) / 4 * b, d = d / a.step * a.step,
    ...
    c.fn.ionRangeSlider = function (s) {
        if (G[s])return G[s].apply(this, Array.prototype.slice.call(arguments, 1));
        if ("object" !== typeof s && s)c.error("Method " + s + " does not exist for jQuery.ionRangeSlider"); else return G.init.apply(this, arguments)
    }
